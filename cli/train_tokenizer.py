...
from src.tokenizer_model import (
    BaseTokenizer,
...
from cli.config import DefaultArgumentsConfig, DefaultConfig, register_base_configs
...
class Config(DefaultConfig):
    ...
    tokenizer_model: SentencePieceTokenizerConfig = SentencePieceTokenizerConfig()
...
def main(cfg: Config) -> None:
    ...
    tokenizer = SentencePieceTokenizer(cfg.tokenizer_model)
    ...
    tokenizer = T5TokenizerFast(
        ...
        model_max_length=cfg.tokenizer_model.model_max_length,
    )
